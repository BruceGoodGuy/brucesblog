...
(function ($) {
	...
	var Rewall = {
		...
		scrollToAnchor: function () {
			$('.main_button a, .anchor_nav a').on('click', function () {
				var element = $(this);
			...
			$('.anchor_nav a').on('click', function () {
				var element = $(this);
				$(".anchor_nav li").removeClass("current");
	...
	$(window).on('scroll', function () {
		...
		activeLi("about", about, $(this))
		var biography = $('#biography').offset().top;
		activeLi("biography", biography, $(this))
		var portfolio = $('#portfolio').offset().top;
		activeLi("portfolio", portfolio, $(this))
		// var service = $('#service').offset().top;
		// activeLi("service", service, $(this))
		// var customer = $('#customer').offset().top;
		// activeLi("customer", customer, $(this))
		// var blog = $('#blog').offset().top;
		// activeLi("blog", blog, $(this))
		// var contact = $('#contact').offset().top;
		// activeLi("contact", contact, $(this))
	});

	function activeLi(id, position, that) {
		if (that.scrollTop() >= position) {
			// Your div has reached the top
			$(".anchor_nav li").removeClass('current');
			$(".anchor_nav a[href='#" + id + "']").closest('li').addClass('current');
		}
	}
